...
- Detects canonical URLs in both links and raw tweet text (localhost is not linkified by X)
- Recognizes `http://localhost:5175/market/{marketId}` during development
