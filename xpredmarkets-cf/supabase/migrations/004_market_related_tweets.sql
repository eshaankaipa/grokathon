-- Mirror of supabase/migrations/20260808070000_market_related_tweets.sql
-- Prefer applying the root supabase/ migration via `supabase db push`.
-- Kept here so the CF worker package documents the required schema.
