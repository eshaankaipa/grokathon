...
Deno.serve(async (request) => {
  ...
  try {
    ...
    const stripeBody = new URLSearchParams({
      ...
      "line_items[0][price_data][product_data][name]": `${credits.toLocaleString()} Signal demo credits`,
      "line_items[0][price_data][product_data][description]": "Demo credits for hackathon prediction-market trading. No cash value.",
